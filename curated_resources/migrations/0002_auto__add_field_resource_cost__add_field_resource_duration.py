...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.cost'
        db.add_column('curated_resources_resource', 'cost',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.duration'
        db.add_column('curated_resources_resource', 'duration',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.cost'
        db.delete_column('curated_resources_resource', 'cost')

        # Deleting field 'Resource.duration'
        db.delete_column('curated_resources_resource', 'duration')
