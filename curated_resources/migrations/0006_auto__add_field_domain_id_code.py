...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Domain.id_code'
        db.add_column('curated_resources_domain', 'id_code',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Domain.id_code'
        db.delete_column('curated_resources_domain', 'id_code')
